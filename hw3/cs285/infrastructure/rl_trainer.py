...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        self.log_video = self.params['video_log_freq'] != -1
        # Set random seeds
    ...
    def collect_training_trajectories(self, itr, initial_expertdata, collect_policy, num_transitions_to_sample, save_expert_data_to_disk=False):
        ...
        if initial_expertdata != None and itr == 0:
        ...
        # if save_expert_data_to_disk != None:
        #     torch.save(collect_policy.state_dict(), save_expert_data_to_disk)
