...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            sample_index = np.random.choice(num_data, 
                                             num_data_per_ens, replace=True)
            observations = ob_no[sample_index]
            actions = ac_na[sample_index]
            next_observations = next_ob_no[sample_index]
