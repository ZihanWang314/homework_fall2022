...
class FFModel(nn.Module, BaseModel):
    ...
    def forward(
        ...
        obs_normalized = normalize(obs_unnormalized,
                                   obs_mean, obs_std)# TODO(Q1)
        acs_normalized = normalize(acs_unnormalized,
                                   acs_mean, acs_std)# TODO(Q1)
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        prediction = ptu.to_numpy(next_obs_pred)# TODO(Q1) get the predicted next-states (s_t+1) as a numpy array
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        target = ptu.from_numpy(normalize(next_observations - observations, 
                           ...
                           data_statistics['delta_std']))# TODO(Q1) compute the normalized target for the model.
