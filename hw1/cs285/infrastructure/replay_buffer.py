...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        indexes = np.random.permutation(self.obs.shape[0])[:batch_size]
        ...
        return self.obs[indexes], self.acs[indexes], self.rews[indexes], self.next_obs[indexes], self.terminals[indexes]
