...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(
        ...
        if load_initial_expertdata != None and itr == 0:
        ...
        paths, envsteps_this_batch = utils.sample_trajectories(self.env, collect_policy, batch_size, self.params['ep_len'], self.log_video, use_pool = False)
        print([len(i['reward']) for i in paths])
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            sample_out = self.agent.sample(self.params['batch_size'])
            ob_batch, ac_batch, re_batch, next_ob_batch, terminal_batch =  sample_out
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths, training_logs):
        ...
        eval_paths, eval_envsteps_this_batch = utils.sample_trajectories(self.env, eval_policy, self.params['eval_batch_size'], self.params['ep_len'], use_pool = False)
